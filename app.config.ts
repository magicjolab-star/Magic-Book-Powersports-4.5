...
const androidPackage = process.env.APP_ANDROID_PACKAGE || 'com.magicjolab.magicbook';
const versionCode = Number(process.env.APP_ANDROID_VERSION_CODE || '41001');
...
const config: ExpoConfig = {
 name:'Magic Book Powersports', slug:'magic-book-powersports-beta', version:'4.1.0',
